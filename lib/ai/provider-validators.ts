...
/**
 * OpenRouter fala a API da OpenAI, então o discovery é o mesmo `/models` com
 * Bearer. A diferença que importa: os ids vêm qualificados por vendor
 * (`anthropic/claude-sonnet-5`) — é assim que se escolhe o modelo lá.
 */
